...
INSERT INTO `account` VALUES (124764357,748912,'Kshitish',1247,98592.00,9011152660),(240894527,478956,'MAHESH BHATT',1966,98642.00,8901627803),(297851263,483312,'AKANSHA AGARWAL',2976,47755.00,7569812648),(457059051,597842,'KARTIK GUPTA',4379,497924.41,4523105479),(457891206,697459,'GAURI PANDEY',1970,987564.00,8945278321),(457981464,457896,'ANSHUL BRIJWASI',4592,4159.35,9856471302),(477851364,469757,'MUSKAN AHUJA',4785,7648.00,8746520169),(578401604,789568,'AKASH JOSHI',9422,980000.00,7746021598),(678945230,578912,'TINA GOENKA',5037,75749.00,8520346978),(879512680,378945,'MAHESH KULKARNI',7890,7618.00,9826710267);
...
CREATE TABLE `auth_keys` (
  ...
  `TYPE` enum('ecg','face','fingerprint') NOT NULL,
...
INSERT INTO `authorizes` VALUES ('AGARWAL9422',297851263),('AKASH8122',578401604),('gau',457891206),('GOENKA101',678945230),('HOPE.KARTIK',457059051),('hope.kartik',879512680),('ksdfg',124764357),('ksdfg',297851263),('ksdfg',477851364),('KULKARNI23',879512680),('MAHESH123',240894527),('mishti',457981464),('MUSKAAN',477851364);
...
INSERT INTO `transactions` VALUES (59069854,124764357,297851263,100.00,'2019-09-22 12:42:30'),(123456789,124764357,240894527,10.01,'2019-09-19 20:32:17'),(350827661,879512680,124764357,54.00,'2019-09-19 23:04:53'),(531551383,457981464,678945230,100.00,'2019-09-21 16:42:30'),(561406084,457059051,124764357,100.00,'2019-09-19 23:18:32'),(1482198676,124764357,457059051,0.60,'2019-09-19 23:20:59'),(1681548245,457981464,124764357,10.00,'2019-09-21 12:40:47'),(1914810633,124764357,477851364,69.00,'2019-09-19 22:54:54');
...
INSERT INTO `user` VALUES ('AGARWAL9422','AKANSHA AGARWAL','VEWBIBXEW17'),('AKASH8122',' AKASH JOSHI','ASTFBHB78WR'),('gau','GAURI PANDEY','AYUBUVFUCDQ'),('GOENKA101',' TINA GOENKA','JVSAYVTCT5JB'),('HOPE.KARTIK','KARTIK GUPTA','woof'),('ksdfg','KSHITISH D','miura'),('KULKARNI23','MAHESH KULKARNI','CSTY1472GC'),('MAHESH123','MAHESH BHATT','XRTBIH@35BY'),('manas.km','Manas','zoro'),('mishti','ANSHUL BRIJWASI','MISHTI101'),('MUSKAAN',' MUSKAN AHUJA','OM235DDGCB');
...
-- Dump completed on 2019-09-22 16:26:39
